...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/reset-proses', [AuthController::class, 'reset_proses'])->name('reset-proses');
});
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('profile_password', [ProfileController::class, 'ubah'])->name('profile.ubah');
    Route::put('profile/{user}', [ProfileController::class, 'update'])->name('profile.update');
    Route::put('profile_password/{user}', [ProfileController::class, 'password'])->name('profile.password');
